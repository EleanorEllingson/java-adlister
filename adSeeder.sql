...
VALUES ('Bobby Bob', 'bobby@email.com', '$2a$12$hMBHftm'),
       ('Sally Smith', 'sally@email.com', '$2a$12$hMBH'),
       ('Karen Schultz', 'karen@email.com', '$2a$12$hM'),
       ('Fred White', 'fred@email.com', '$2a$12$hMBHf'),
       ('Bud Gibson', 'bud@email.com', '$2a$12$hMBH');
